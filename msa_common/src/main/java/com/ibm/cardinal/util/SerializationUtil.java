...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.per.msa_login.auth.AuthService", "USER_REMOTE_TYPE");
        type_category_map.put("com.per.msa_login.login.LoginDAO", "USER_REMOTE_TYPE");
        type_category_map.put("com.per.msa_login.login.LoginService", "USER_REMOTE_TYPE");
        type_category_map.put("com.per.msa_login.login.LoginController", "USER_REMOTE_TYPE");
    }
